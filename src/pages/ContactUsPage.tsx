  ...
  return (
    <>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8 md:p-12 bg-[#926cad]">
                ...
                <h3 className="text-3xl font-bold text-white mb-8 title-font">{t('writeUs')}</h3>
              ...
              <div className="bg-[#d1d451] p-8 md:p-12 text-white">
                <h2 className="text-4xl font-bold mb-8 title-font">{t('contactUs')}</h2>
                <div className="space-y-6">
                  <a href="tel:+17862800961" className="flex items-center text-xl hover:text-[#926cad] transition duration-300 body-font">
                    <Phone className="w-6 h-6 mr-4" />
                    +1 (786) 280-0961
                  </a>
                  <a href="mailto:info@beevsoven.com" className="flex items-center text-xl hover:text-[#926cad] transition duration-300 body-font">
                    <Mail className="w-6 h-6 mr-4" />
                    info@beevsoven.com
                  </a>
                  <a href="https://wa.me/17862800961" target="_blank" rel="noopener noreferrer" className="flex items-center text-xl hover:text-[#926cad] transition duration-300 body-font">
                ...
                <div className="mt-12">
                  <h3 className="text-2xl font-bold mb-6 title-font">{t('followUs')}</h3>
                  <div className="space-y-4">
                    <a href="https://www.instagram.com/beevsoven/profilecard/?igsh=MXhtN2djMnJtaHp2bA==" target="_blank" rel="noopener noreferrer" className="flex items-center text-xl hover:text-[#926cad] transition duration-300 body-font">
                      <Instagram className="w-6 h-6 mr-4" />
                      Instagram
                    </a>
                    <a href="https://www.tiktok.com/@beevsoven?_t=8qekMoITjKc&_r=1" target="_blank" rel="noopener noreferrer" className="flex items-center text-xl hover:text-[#926cad] transition duration-300 body-font">
                      <svg className="w-6 h-6 mr-4" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-5.2 1.74 2.89 2.89 0 012.31-4.64 2.93 2.93 0 01.88.13V9.4a6.84 6.84 0 00-1-.05A6.33 6.33 0 005 20.1a6.34 6.34 0 0010.86-4.43v-7a8.16 8.16 0 004.77 1.52v-3.4a4.85 4.85 0 01-1-.1z"/>
                      </svg>
                      TikTok
                    </a>
                    <a href="https://www.facebook.com/profile.php?id=61566809876928" target="_blank" rel="noopener noreferrer" className="flex items-center text-xl hover:text-[#926cad] transition duration-300 body-font">
      ...
      <motion.a
        ...
        className="fixed bottom-6 right-6 z-50 bg-green-500 text-white p-4 super-rounded shadow-lg hover:bg-green-600 transition-colors"
